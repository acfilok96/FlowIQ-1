...
def Gemini_function(system_prompt = "Share response.\n\n"):
    ...
    if prompt := st.chat_input("Message here !"):
        ...
        with st.spinner(":green[just wait . . .]"):
            try: 
                ...
                full_response = ChatModel.GeminiModel(prompt, system_prompt)
        ...
        # col1.image("Image1/tony.jpg")
        st.info("""
        
        FlowIQ is a AI chatbot, a specialized hardware and software platform designed for \
        efficient and high-performance artificial intelligence (AI) and machine learning (ML) \
        workloads.

        It delivers exceptional compute speed, quality, and energy efficiency.
        Key features of the FlowIQ platform include low power consumption, high throughput, and low latency. 
